...
public class SwaggerConfiguration {
  ...
  public Docket api(){
      ...
      return new Docket(DocumentationType.OAS_30)
              .select()
              .apis(RequestHandlerSelectors.basePackage("com.flightticket"))
	...
	public ApiInfo apiEndPointInfo(){
      return new ApiInfoBuilder().title("Flight Ticket Booking")
              .description("Booking a flight is easy now")
              //.contact(new Contact("Individual Project", "https://FlightBooking.com", "pjbeth1607@gmail.com"))
              .license("Apache 2.0")
